   <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-list-toggle">
                <a href="{{route('admin.chat.index')}}" class="nav-link nav-link-lg message-envelope {{$unseenMessages > 0 ? 'beep' : ''}}"><i class="far fa-envelope"></i></a>
            
           </li>
          
         
          
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg notification_beep {{count($notifications) > 0 ? 'beep' : '' }}"><i class="far fa-bell"></i></a>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
              ...
              <li><a class="nav-link" href="{{route('admin.dayly-offer.index')}}"><i class="far fa-square"></i> <span>Daily Offer</span></a></li>
              ...
              <li><a class="nav-link" href="{{route('admin.chat.index')}}">
                  <i class="far fa-square"></i> <span>Messages</span></a><li class="dropdown">

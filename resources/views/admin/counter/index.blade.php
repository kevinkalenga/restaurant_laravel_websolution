        ...
        <div class="card-body">
            <form action="{{ route('admin.counter.update') }}" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="counter_count_one" class="form-control">
                   
                </div>

                <div class="form-group">
                    <label>Counter Count Name</label>
                    <input type="text" name="counter_name_one" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="counter_count_two" class="form-control">
                   
                </div>

                <div class="form-group">
                    <label>Counter Count Name Two</label>
                    <input type="text" name="counter_name_two" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="counter_count_three" class="form-control">
                   
                </div>

                <div class="form-group">
                    <label>Counter Count Name Three</label>
                    <input type="text" name="counter_name_three" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="counter_count_four" class="form-control">
                   
                </div>

                <div class="form-group">
                    <label>Counter Count Name Four</label>
                    <input type="text" name="counter_name_four" class="form-control">
